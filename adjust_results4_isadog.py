...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # Reading in and processing dogname.txt
    ...
    with open('dognames.txt', 'r') as dognames:
        ...
        # Iterate thru each line of dognames
        for line in dognames:
            dog = line.rstrip()
            
            if dog in dognames_dic:
    ...
    # Loop thru keys (filenames) of results_dic
    for filename in results_dic:
        
        # Pet image label 
        pet_image_label = results_dic[filename][0]
        ...
        if pet_image_label in dognames_dic:
            ...
            if classifier_label in dognames_dic:
                ...
                # index 3: 1 = Pet Image Label 'is a dog'
                # index 4: 1 = Classifier Label 'is a dog'
            ...
            # if classifier label 'is not a dog'
                ...
                # index 3: 1 = Pet Image Label 'is a dog'
                # index 4: 0 = Classifier Label 'is not a dog'
                results_dic[filename].extend([1,0])

        # If pet image label 'is not a dog'
        else:
            
            # if classifier label 'is a dog'
            if classifier_label in dognames_dic:
                        
                # index 3: 1 = Pet Image Label 'is not a dog'
                # index 4: 1 = Classifier Label 'is a dog'
